...
import UpdateClanChannelEncoder from '#/network/game/server/codec/UpdateClanChannelEncoder.js';
...
import PDialogPromptEncoder from '#/network/game/server/codec/PDialogPromptEncoder.js';
...
import IfSetInvOpEncoder from '#/network/game/server/codec/IfSetInvOpEncoder.js';
...
class ServerGameProtRepository {
    ...
    constructor() {
        ...
        this.bind(IfSetInvOp, new IfSetInvOpEncoder());
        ...
        this.bind(UpdateClanChannel, new UpdateClanChannelEncoder());
        ...
        this.bind(PDialogPrompt, new PDialogPromptEncoder());
